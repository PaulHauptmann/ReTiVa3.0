...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, text="Start" , command=self.button_starter)
        self.sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, command=self.button_stop_command)
        self.sidebar_button_2.grid(row=2, column=0, padx=20, pady=10)
        self.sidebar_button_3 = customtkinter.CTkButton(self.sidebar_frame, command=self.Button_deleter)
    ...
    def button_starter(self):
        ...
        t = threading.Thread(target=self.button_start_command)
        t.start()
